        ...
        if (historical) {
          return (
            <Title>
              ...
              >
                <option selected = {"days" === timeInterval} value="days">Days</option>
                <option  selected = {"weeks" === timeInterval} value="weeks">Weeks</option>
                <option selected = {"months" === timeInterval} value="months">Months</option>
              </ChartSelect>
